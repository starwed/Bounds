...
waitForMap = function(level, glyph) {
  ...
  map = Crafty.e("TiledLevel").tiledLevel(level.url, "WebGL").bind("TiledLevelLoaded", function() {
...
levelSelect = function() {
  var clickFactory, col, completionPoints, completionRate, e, hoverFactory, instructions2, lIndex, lev, level, levelMenu, levelText, parText, passMarker, passedText, rateText, row, selectorBG, selectorText, xpos, _j, _len1, _ref1, _ref2;
  if (!audioPlaying) {
